...
describe 'OAuthServices'
  ...
  describe 'OAuthServices Request Token'
    it 'Should Correctly Request token' 
      var oauthServices = new oauth.OAuthServices({
        ...
        applicationByConsumerKey: function(consumerKey, callback) { callback(null, {consumer_key:'key', secret:'secret'}); },
        cleanRequestTokens: function(consumerKey, callback) {callback(null, null);}, associateTokenToUser: function(username, token, callback) {},
    ...
    it 'Should Fail du to no valid parameters' 
      var oauthServices = new oauth.OAuthServices({
        ...
        cleanRequestTokens: function(consumerKey, callback) {}, generateRequestToken: function(oauthConsumerKey, oauthCallback, callback) {}, validateNotReplay: function(accessToken, timestamp, nonce, callback) {}, associateTokenToUser: function(username, token, callback) {},
    
        applicationByConsumerKey: function(consumerKey, callback) { callback(new Error("fail"), null); }
      })
    ...
    it 'Should Fail to retrieve request token due to illegal signature'
      var oauthServices = new oauth.OAuthServices({
        previousRequestToken: function(token, callback) {}, tokenByConsumer: function(consumerKey, callback) {}, validToken: function(accessToken, callback) {}, authenticateUser: function(username, password, oauthToken, callback) {}, generateAccessToken: function(oauthToken, callback) {},
        generateRequestToken: function(oauthConsumerKey, oauthCallback, callback) {}, validateNotReplay: function(accessToken, timestamp, nonce, callback) {}, associateTokenToUser: function(username, token, callback) {},
    ...
    it 'Should Fail to generate a token due to an internal provider error generating a request'
      var oauthServices = new oauth.OAuthServices({
        previousRequestToken: function(token, callback) {}, tokenByConsumer: function(consumerKey, callback) {}, validToken: function(accessToken, callback) {}, authenticateUser: function(username, password, oauthToken, callback) {}, generateAccessToken: function(oauthToken, callback) {}, validateNotReplay: function(accessToken, timestamp, nonce, callback) {}, associateTokenToUser: function(username, token, callback) {},
  ...
  describe 'OAuthServices Authenticate User'
    it 'Correctly Authenticate User'
      var oauthServices = new oauth.OAuthServices({
        ...
        generateAccessToken: function(oauthToken, callback) {}, applicationByConsumerKey: function(consumerKey, callback) {}, cleanRequestTokens: function(consumerKey, callback) {}, generateRequestToken: function(oauthConsumerKey, oauthCallback, callback) {}, validateNotReplay: function(accessToken, timestamp, nonce, callback) {},
  
        associateTokenToUser: function(username, token, callback) { callback(null, null); },
  ...
  **/  
  ...
  it 'Should fail due to illegal signature'
    var oauthServices = new oauth.OAuthServices({
      tokenByConsumer: function(consumerKey, callback) {}, validToken: function(accessToken, callback) {}, authenticateUser: function(username, password, oauthToken, callback) {},
      cleanRequestTokens: function(consumerKey, callback) {}, generateRequestToken: function(oauthConsumerKey, oauthCallback, callback) {}, generateAccessToken: function(oauthToken, callback) {}, validateNotReplay: function(accessToken, timestamp, nonce, callback) {}, associateTokenToUser: function(username, token, callback) {},
  ...
  it 'Should fail due to missing parameters'
    var oauthServices = new oauth.OAuthServices({
      tokenByConsumer: function(consumerKey, callback) {}, validToken: function(accessToken, callback) {}, authenticateUser: function(username, password, oauthToken, callback) {},
      cleanRequestTokens: function(consumerKey, callback) {}, generateRequestToken: function(oauthConsumerKey, oauthCallback, callback) {}, validateNotReplay: function(accessToken, timestamp, nonce, callback) {},
      applicationByConsumerKey: function(consumerKey, callback) {}, tokenByConsumer: function(consumerKey, callback) {}, previousRequestToken: function(token, callback) {}, generateAccessToken: function(oauthToken, callback) {}, associateTokenToUser: function(username, token, callback) {},
    })
  ...
  **/  
  describe 'OAuthServices access token'
    ...
    it 'Should fail due to illegal token'    
      var oauthServices = new oauth.OAuthServices({
        tokenByConsumer: function(consumerKey, callback) {}, authenticateUser: function(username, password, oauthToken, callback) {}, applicationByConsumerKey: function(consumerKey, callback) {},
        cleanRequestTokens: function(consumerKey, callback) {}, generateRequestToken: function(oauthConsumerKey, oauthCallback, callback) {},
        applicationByConsumerKey: function(consumerKey, callback) {}, tokenByConsumer: function(consumerKey, callback) {}, previousRequestToken: function(token, callback) {}, generateAccessToken: function(oauthToken, callback) {}, validateNotReplay: function(accessToken, timestamp, nonce, callback) {}, associateTokenToUser: function(username, token, callback) {},
